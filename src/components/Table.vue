  ...
  <div class="searchBar">
    <!-- Filter Search -->
      <div class="input-group mb-5">
        <input type="search" class="form-control" v-model='searchQuery' placeholder="Github project" aria-label="Recipient's username" aria-describedby="button-addon2">
      </div>
  </div>
...
export default {
  ...
  setup(props) {
    ...
    const sortTable = (col) => {
      ...
      updatedList.value = sortBy(props.GithubData,col)
      }
